...
class Learner:
    def __init__(self, model, criterion, optimizer, dataloader_dict, num_epochs, 
                 device, stage, hyper_params, scheduler=None, last_epoch=None, grad_accumulation_step=1):
    ...
    def fit(self):
        ...
        for i in range(self.num_epochs):
            ...
            for phase in ['train', 'val']:
                ...
                if phase == 'train': 
                    ...
                    model_name = '_{}_{:.2f}_val_{:.2f}_tr_{}.pth'.format(
                        i+self.last_epoch if self.last_epoch else i, valid_loss[-1], train_loss[-1], self.stage
                    )
        ...
        metrics = {
            'Train_Loss': train_loss[-1], 'Val_Loss': valid_loss[-1],
        ...
        for step in range(total_steps):
            ...
            with torch.set_grad_enabled(phase == 'train'):
                ...
                if phase == 'train':
                    ...
                    # writing weights and grads to tensorboard's histogram
